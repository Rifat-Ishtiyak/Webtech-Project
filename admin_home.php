...
<body>
    <table border="1" width="100%">
        <tr>
            ...
            <td align="center"><a href="home.php">Home</a> | <a href="view/admin_login.html">Admin Login</a> | <a href="view/Admin_registration.php">Admin Registration</a></td>
        </tr>
        <tr>
            <td style="background-color:rgb(171, 178, 185);">
                <a href="../project/view/notice.php"><button>notices</button></a>
                
            </td>
            <td  height="550px" align="center" style="background-color:lightblue;">
                    <a href="../project/view/teacher_login.html"><button style="background-color: lightgreen;">Teacher Login</button><a/><br>
                    <a href="../project/view/student_login.html"><button style="background-color: lightgreen;">student Login</button><a/><br>
                    <a href="../project/view/parents_login.html"><button style="background-color: lightgreen;">Parents Login</button><a/><br>
            </td>
